/**
 * Upload Controller - Handles profile picture uploads
 */
...
const uploadProfilePicture = asyncHandler(async (req, res) => {
  ...
  // The image will be served at /api/users/profile-pictures/:filename
  const imageUrl = `/api/users/profile-pictures/${req.file.filename}`;
